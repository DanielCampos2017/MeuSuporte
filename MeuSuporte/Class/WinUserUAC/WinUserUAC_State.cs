        ...
        public async Task Notification(bool State, int ValueUniProgressBar)
        {
            ...
            try
            {
                ...
                using (RegistryKey key = CurrentVersion.OpenSubKey("System", writable: true))
                {
                    ...
                    await WinGlobal_UIService2.Instance.Log_MensagemAsync("Notificações do Usuario UAC: Alterado", true);                 
                }
                WinGlobal_UIService2.Instance.ProgressBarADD(ValueUniProgressBar / 2);
            ...
            {
                WinGlobal_UIService2.Instance.Log_MensagemAsync("Notificações do Usuario UAC: Erro!", true);
